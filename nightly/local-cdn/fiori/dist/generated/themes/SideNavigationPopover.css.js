...
export default `.ui5-side-navigation-popover{--_ui5-v2-8-0-rc-0_popover_box_shadow: var(--_ui5-v2-8-0-rc-0_side_navigation_popup_box_shadow)}.ui5-side-navigation-popover::part(content){padding:0}.ui5-hidden-text{position:absolute;clip:rect(1px,1px,1px,1px);user-select:none;left:-1000px;top:-1000px;pointer-events:none;font-size:0}
`;
