...
const styleData = { packageName: "@ui5/webcomponents", fileName: "themes/TabSemanticIcon.css.ts", content: `.ui5-tab-semantic-icon{display:var(--_ui5-v2-3-0-rc-3_tc_headerItemSemanticIcon_display);height:var(--_ui5-v2-3-0-rc-3_tc_headerItemSemanticIcon_size);width:var(--_ui5-v2-3-0-rc-3_tc_headerItemSemanticIcon_size);margin-inline-end:.5rem}.ui5-tab-semantic-icon--positive{color:var(--sapPositiveElementColor)}.ui5-tab-semantic-icon--negative{color:var(--sapNegativeElementColor)}.ui5-tab-semantic-icon--critical{color:var(--sapCriticalElementColor)}
` };
