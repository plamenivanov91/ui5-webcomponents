...
// 		cy.get("@shellbar").find("ui5-shellbar-item").as("customActionIcon1");
...
// 		cy.get("@overflowPopover").find("slot").should("have.length", 2);
// 	});
...
describe("ButtonBadge in ShellBar", () => {
	it("Test if ShellBarItem count appears in ButtonBadge", () => {
		...
		cy.get("#shellbarwithitems")
			.find("ui5-shellbar-item ui5-button-badge[slot='badge']")
			.should("exist")
