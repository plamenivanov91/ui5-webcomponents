import{x as b}from"./lit-element-c5a2b594.js";import{l as t}from"./if-defined-c29cffe1.js";import{o as M}from"./unsafe-html-0ddd83da.js";import{C as d}from"./CalendarType-4d682252.js";const v={selectionMode:{control:"select",options:["Single","Multiple","Range"]},primaryCalendarType:{control:"select",options:["Gregorian","Islamic","Japanese","Buddhist","Persian"]},secondaryCalendarType:{control:"select",options:["Gregorian","Islamic","Japanese","Buddhist","Persian"]},calendarLegend:{control:{type:"text"},table:{type:{summary:"Array<CalendarLegend>"}}},default:{control:{type:"text"},table:{type:{summary:"Array<ICalendarSelectedDates>"}}},specialDates:{control:{type:"text"},table:{type:{summary:"Array<SpecialCalendarDate>"}}},"selection-change":{description:"Fired when the selected dates change.\n\n**Note:** If you call `preventDefault()` for this event, the component will not\ncreate instances of `ui5-date` for the newly selected dates. In that case you should do this manually.",control:{type:!1},table:{category:"events"},UI5CustomData:{parameters:[{type:{text:"Array<string>"},name:"selectedValues",_ui5privacy:"public",description:"The selected dates"},{type:{text:"Array<number>"},name:"selectedDates",_ui5privacy:"public",description:"The selected dates as UTC timestamps"}]}}},A={package:"@ui5/webcomponents",since:"1.0.0-rc.11",tagName:"ui5-calendar"};var l=Object.freeze,S=Object.defineProperty,_=(e,x)=>l(S(e,"raw",{value:l(x||e.slice())})),o;const w={title:"Main/Calendar",component:"Calendar",argTypes:v},i=e=>b`<ui5-calendar
